...
BENCH_VALS_DICT = {
    ...
    esl.StatsGroup.HD: ArrayBIGINT([
        [0, 0, 386, 2977, 2957, 1261, 2859],
        [0, 100, 225, 1187, 1170, 367, 1037],
        [0, 200, 97, 337, 329, 108, 260],
        [0, 300, 42, 110, 102, 50, 97],
        [0, 500, 0, 4, 4, 1, 3],
        [0, 800, 0, 0, 0, 0, 0],
        [0, 1200, 0, 0, 0, 0, 0],
        [0, 2500, 0, 0, 0, 0, 0],
        [1800, 0, 300, 2322, 2289, 935, 2172],
        [1800, 100, 186, 1055, 991, 362, 892],
        [1800, 200, 109, 418, 374, 132, 336],
        [1800, 300, 100, 251, 207, 98, 188],
        [1800, 500, 16, 17, 14, 4, 9],
        [1800, 800, 0, 0, 0, 0, 0],
        [1800, 1200, 0, 0, 0, 0, 0],
        [1800, 2500, 0, 0, 0, 0, 0],
        [2000, 0, 713, 5038, 4944, 2086, 4725],
        [2000, 100, 547, 2424, 2188, 838, 2048],
        [2000, 200, 421, 1208, 978, 430, 1004],
        [2000, 300, 429, 955, 647, 348, 722],
        [2000, 500, 153, 220, 110, 98, 153],
        [2000, 800, 2, 1, 0, 0, 0],
        [2000, 1200, 0, 0, 0, 0, 0],
        [2000, 2500, 0, 0, 0, 0, 0],
        [2400, 0, 1082, 7576, 7350, 3157, 7146],
        [2400, 100, 919, 4110, 3443, 1446, 3489],
        [2400, 200, 739, 2330, 1652, 790, 1796],
        [2400, 300, 1062, 2173, 1214, 795, 1604],
        [2400, 500, 905, 1115, 356, 435, 741],
        [2400, 800, 244, 179, 0, 77, 105],
        [2400, 1200, 1, 0, 0, 0, 0],
        [2400, 2500, 0, 0, 0, 0, 0],
        [3000, 0, 1512, 10254, 9771, 4341, 9670],
        [3000, 100, 1866, 6940, 5358, 2551, 5912],
        [3000, 200, 1508, 4414, 2847, 1503, 3463],
        [3000, 300, 2448, 4915, 2108, 1725, 3479],
        [3000, 500, 2689, 3127, 621, 1190, 2088],
        [3000, 800, 2340, 1637, 0, 634, 948],
        [3000, 1200, 760, 383, 0, 143, 197],
        [3000, 2500, 0, 0, 0, 0, 0],
        [4000, 0, 1228, 8915, 8701, 3650, 8355],
        [4000, 100, 1020, 3995, 3133, 1330, 3188],
        [4000, 200, 832, 2233, 1310, 739, 1757],
        [4000, 300, 1499, 2589, 928, 838, 1732],
        [4000, 500, 1742, 1929, 289, 705, 1204],
        [4000, 800, 2025, 1338, 0, 445, 699],
        [4000, 1200, 3556, 1314, 0, 496, 635],
        [4000, 2500, 0, 0, 0, 0, 0],
        [5000, 0, 1138, 7683, 7284, 3319, 7254],
        [5000, 100, 1868, 6219, 4532, 2201, 4977],
        [5000, 200, 1773, 4515, 2752, 1522, 3427],
        [5000, 300, 2925, 4961, 1884, 1631, 3386],
        [5000, 500, 3635, 3731, 490, 1211, 2090],
        [5000, 800, 4011, 2316, 0, 831, 1233],
        [5000, 1200, 10655, 3103, 0, 915, 1150],
        [5000, 2500, 3217, 549, 0, 120, 139],
        [7000, 0, 898, 7420, 7420, 3075, 7108],
        [7000, 100, 271, 1600, 1572, 468, 1373],
        [7000, 200, 427, 305, 0, 35, 86],
        [7000, 300, 858, 536, 0, 63, 122],
        [7000, 500, 1374, 546, 0, 70, 104],
        [7000, 800, 1809, 494, 0, 68, 101],
        [7000, 1200, 6798, 1117, 0, 166, 199],
        [7000, 2500, 24640, 2003, 0, 213, 235],
    ]),
}
